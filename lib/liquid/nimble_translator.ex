defmodule Liquid.NimbleTranslator do
  ...
  defp check_blank(%Liquid.Block{name: :if, nodelist: nodelist, elselist: elselist} = translated)
  ...
  defp check_blank(%Liquid.Block{nodelist: nodelist} = translated)
  ...
  defp check_blank(translated), do: translated
end
